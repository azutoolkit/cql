...
Users = Cql::Repository(User).new(Billing, :users)
...
describe Cql::Repository(User) do
  ...
  it "creates a new user" do
    Users.create(id: 1, name: "John Doe", email: "john@example.com")
    user = Users.find!(1)
  ...
  it "fetches all users" do
    Users.create(id: 1, name: "John Doe", email: "john@example.com")
    Users.create(id: 2, name: "Jane Doe", email: "jane@example.com")
  ...
  it "updates a user by ID" do
    Users.create(id: 1, name: "John Doe", email: "john@example.com")
    Users.update(1, name: "John Updated", email: "john.updated@example.com")
    user = Users.find!(1)
  ...
  it "deletes a user by ID" do
    user_id = Users.create(id: 1, name: "John Doe", email: "john@example.com")
  ...
  it "fetches users with pagination" do
    (1..20).each do |i|
      Users.create(id: i, name: "User #{i}", email: "user#{i}@example.com")
    end
