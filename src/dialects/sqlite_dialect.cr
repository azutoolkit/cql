...
module Expression
  ...
  class SqliteDialect < BaseDialect
    ...
    def define_column(
      ...
      # SQLite requires parentheses around function expressions in DEFAULT: DEFAULT (datetime('now'))
      if timestamp_column && default_value.is_a?(String) && default_value.starts_with?("datetime(")
