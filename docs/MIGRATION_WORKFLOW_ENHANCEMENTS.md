# Migration Workflow Documentation Enhancements
...
1. [Integrated Migration Workflow](guides/active-record-with-cql/integrated-migration-workflow.md) - Start here
2. [Active Record Migrations](guides/active-record-with-cql/migrations.md) - Implementation details
3. [Migration Best Practices](guides/handling-migrations.md) - Advanced patterns
4. [Schema Dump](guides/schema-dump.md) - Integration details
