...
* [🔧 Setup & Installation Issues](troubleshooting.md#-setup--installation-issues)
* [📊 Database Connection Problems](troubleshooting.md#-database-connection-problems)
* [🏗️ Schema & Migration Issues](troubleshooting.md#️-schema--migration-issues)
* [🔍 Query & Model Issues](troubleshooting.md#-query--model-issues)
* [⚠️ Runtime Errors](troubleshooting.md#️-runtime-errors)
* [⚡ Performance Issues](troubleshooting.md#-performance-issues)
* [🛠️ Development Tips](troubleshooting.md#️-development-tips)
...
**Solution:** Add the appropriate database driver to your `shard.yml`:
