...
**👉** [**Learn Design Patterns →**](patterns/)
...
* [**Getting Started Guide**](../getting-started/getting-started.md) - Build your first CQL application
* [**Active Record with CQL**](../active-record-with-cql/active-record-with-cql.md) - Learn the most popular pattern
* [**Configuration Guide**](../getting-started/configuration.md) - Set up for your environment

### Need More Details?

* [**Architecture Overview**](../getting-started/architecture-overview.md) - Deep dive into CQL's design
* [**Best Practices**](../getting-started/best-practices.md) - Follow proven patterns
* [**Examples**](../examples-and-tutorials/examples.md) - See CQL in action

### Getting Stuck?

* [**Troubleshooting Guide**](../help-and-resources/troubleshooting.md) - Solve common problems
* [**FAQ**](../help-and-resources/faqs.md) - Find quick answers
* [**Community**](../help-and-resources/community.md) - Get help from others
...
> Try building a simple application using these concepts before moving to the advanced guides. The [Examples](../examples-and-tutorials/examples.md) section has great starting points!
