...
* [Schema Dump Guide](../database-management/schema-dump.md) - Working with existing databases
* [Migration Workflow Guide](../active-record-with-cql/integrated-migration-workflow.md) - Advanced patterns and real-world examples
