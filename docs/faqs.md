...
For more setup details, see the [Active Record Setup Guide](./guides/active-record-with-cql/README.md#prerequisites-and-setup).
...
- Learn more in the [Defining Models Guide](./guides/active-record-with-cql/defining-models.md).
...
- For comprehensive examples, see the [CRUD Operations Guide](./guides/active-record-with-cql/crud-operations.md).
...
- Refer to the [Validations Guide](./guides/active-record-with-cql/validations.md).
...
- Learn how to use them in the [Callbacks Guide](./guides/active-record-with-cql/callbacks.md).
...
A: The primary resource is the [Active Record with CQL main guide](./guides/active-record-with-cql/README.md), which links to all specialized guides covering different aspects of the Active Record implementation.
