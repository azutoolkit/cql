...
- [Design Patterns](core-concepts/patterns/README.md)
  - [Active Record Pattern](core-concepts/patterns/active-record.md)
  - [Entity Framework Pattern](core-concepts/patterns/entity-framework.md)
...
- [Active Record Overview](guides/active-record-with-cql/README.md)
...
- [Soft Deletes](guides/active-record-with-cql/soft-deletes.md)
- [Touch](guides/active-record-with-cql/touch.md)
